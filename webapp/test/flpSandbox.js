		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Suriya Pandiyan",
									"targetURL": "#compgsuryaaprofilepgsuryaa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compgsuryaaprofilepgsuryaa-display": {
								"semanticObject": "compgsuryaaprofilepgsuryaa",
								"action": "display",
								"description": "Suriya Pandiyan",
								"title": "Suriya Pandiyan",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pgsuryaa.profile.pgsuryaa",
									"url": sap.ui.require.toUrl("com/pgsuryaa/profile/pgsuryaa")
								}
							}
						}
					}
